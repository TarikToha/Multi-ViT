...
model = SiVisionTransformer(get_b16_config(), res_type='mse', num_classes=num_class)
...
for _, row in tqdm(data.iterrows(), total=data.shape[0]):
    ...
    mode1_in_path = f'data/{data_dir}/test/mode1/'
    mode2_in_path = f'data/{data_dir}/test/mode2/'

    mode1_in, mode2_in = [], []
    for frame_id in range(start_frame, end_frame):
        mode1_img = f'{mode1_in_path}{capture_id}_{frame_id}.jpg'
